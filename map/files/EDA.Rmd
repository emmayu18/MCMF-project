...
library(formattable)
load("eda_table.rds")
formattable(program_table, align = c('l', 'c'))
```
...
![](plots/eda1.png){width=65%}
![](plots/eda2.png){width=65%}

![](plots/eda3.png){width=65%}


### Time Series

![](plots/eda4.png){width=65%}

![](plots/eda5.png){width=65%}

### Online 

![](plots/eda6.png){width=65%}

![](plots/eda7.png){width=65%}
<br><br>
